📌 AAS – Automated Attendance System (Backend - Developed by me :) )

This project was developed as part of Smart India Hackathon (SIH).
It is a Node.js + Express + MongoDB based backend system that powers an automated attendance platform for teachers and students.

The system handles authentication, attendance tracking, teacher logins, and secure data storage with modern backend practices like JWT authentication, bcrypt password hashing, and environment-based configuration.

🚀 Features

🔐 User Authentication (JWT-based login system)

👩‍🏫 Teacher Login Portal for managing attendance

📝 Attendance Management APIs for recording & viewing data

📂 MongoDB Integration (local or Atlas cloud support)
...
📑 Demo Data Seeder for quick project setup
...
Frontend (basic UI): HTML pages (Teacher Login, Attendance, Project Page)
